												...
												<div class="direct-chat-messages">
													...
													<div class="direct-chat-msg">
														...
														<img
															...
															src="assetku/img/user1-128x128.jpg"
													...
													<div class="direct-chat-msg right">
														...
														<img
															class="direct-chat-img"
															src="assetku/img/user3-128x128.jpg"
															alt="message user image"
														/>
														<!-- /.direct-chat-img -->
														<div class="direct-chat-text">
													...
													<ul class="contacts-list">
														...
														<li>
															<a href="#">
																<img
																	class="contacts-list-img"
																	src="assetku/img/user7-128x128.jpg"
																	alt="User Avatar"
																/>
														...
														<li>
															<a href="#">
																<img
																	class="contacts-list-img"
																	src="assetku/img/user5-128x128.jpg"
																	alt="User Avatar"
																/>
														...
														<li>
															<a href="#">
																<img
																	class="contacts-list-img"
																	src="assetku/img/user6-128x128.jpg"
																	alt="User Avatar"
																/>
														...
														<li>
															<a href="#">
																<img
																	class="contacts-list-img"
																	src="assetku/img/user8-128x128.jpg"
																	alt="User Avatar"
																/>
										...
										<div class="card">
											...
											<div class="card-body p-0">
												<ul class="users-list clearfix">
													...
													<li>
														<img
															src="assetku/img/user2-160x160.jpg"
															alt="User Image"
														/>
													...
													<li>
														<img
															src="assetku/img/user4-128x128.jpg"
															alt="User Image"
														/>
										...
										<ul class="products-list product-list-in-card pl-2 pr-2">
											<li class="item">
												<div class="product-img">
													<img
														src="assetku/img/default-150x150.png"
														alt="Product Image"
														class="img-size-50"
													/>
												</div>
